<!--
 * @Author: 刘帝君
 * @Date: 2021-11-23 14:07:52
 * @LastEditors: 刘帝君
 * @LastEditTime: 2022-01-18 17:49:48
 * @Descripttion: 门店教练
-->
<template>
    <div>
...
export default {
    ...
    setup() {
        console.log(store.getters.activeHallId, "门店id");
        ...
        const state = reactive({
            formInitData: {
                residentHallId: store.getters.activeHallId,
            },
            form: {
                label: "",
            },
                    ...
                    actives: [
                        {
                            ...
                            method: (val) => {
                                router.push({
                                    path: "/guildHallManagementm/detail",
                                    query: { id: val.id },
                                });
                            },
                        },
