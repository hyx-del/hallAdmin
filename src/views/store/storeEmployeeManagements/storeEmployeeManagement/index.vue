 ...
 * @LastEditors: zx
 * @LastEditTime: 2021-12-28 15:55:22
 * @Descripttion: 员工管理
-->
<template>
    <div>
...
export default {
    ...
    setup() {
        ...
        const state = reactive({
            ...
            button: (val) => {
                if (val.name == "add") {
                    router.push({ path: "/storeEmployeeManagementsm/add" });
                }
                    ...
                    actives: [
                        {
                            ...
                            method: (val) =>
                                router.push({
                                    path: "/storeEmployeeManagementsm/add",
                                    query: { id: val.id },
                                }),
                        },
                        {
                            ...
                            method: (val) =>
                                router.push({
                                    path: "/storeEmployeeManagementsm/detail",
                                    query: { id: val.id },
                                }),
                        },
                        {
                            ...
                            method: (val) => {
                                ...
                                if (state.formInitDataNumber) {
                                    state.formInitDataNumber.mobile =
                                        val.mobile;
                                }
