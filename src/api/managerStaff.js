/*
 * 包含接口：新增员工(staffAddStaffPost),绑定会员(staffBindingMemberPost),获取用户具有的班级信息(staffGetClass),获取用户权限信息(staffGetPermission),获取销售列表(staffGetSaleStaffList),获取用户具有的学校信息(staffGetSchool),登录员工基本信息(staffGetStaffBaseInfo),员工详情(staffGetStaffInfo),员工列表(staffGetStaffList),员工移除(staffRemoveStaffDelete),员工转正(staffStaffConversionPost),员工修改(defaultValue),
 */
