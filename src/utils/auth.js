...
export function getToken() {
    return sessionStorage.getItem("hall_Authorization");
}

export function setToken(token) {
    return sessionStorage.setItem("hall_Authorization", token);
}

export function removeToken() {
    return sessionStorage.removeItem("hall_Authorization");
}
