        ...
        const transFormValueToFileList = () => {
            if (props.modelValue) {
                if (Array.isArray(props.modelValue)) {
                    var _tempArray = props.modelValue.filter(function (s) {
                        return s;
                    });
                    ...
                    let newVal = props.modelValue.split("/");
                    ...
                    state.AudioForm.Audio = props.modelValue;
                } else {
                    state.fileList = [];
                }
            } else {
