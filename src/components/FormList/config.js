...
// 布局的元素
import { setDefault } from "@/components/FormList/selfTools";

export const layoutItems = ["div", "span"];

// 是否要验证
export const confirmRefs = ["addItem"];
// 重置时的默认值 reset
...
// 上传的数组
export const updateArr = ["img", "video", "mp3", "file"];
...
// 需要监听值变化的组
export const checkChange = ["img", "video", "mp3", "file", "textArea", "area"];
// 默认配置
export const inConfig = {
    // 属于label value结构的组件
    // labelValue:['','radio','checkbox'],
    button: {
        el: "formItem",
    },
    backTypeDefault: {
    ...
    pureList: ["", undefined, null],
    pure: true, //纯净模式，会删除返回对象中的'',undefined,null
...
export const inheritObj = {
    ...
    uploadAudio: {
        el: "uploadAudio",
        name: "音频上传",
        list: ["disabled", "size", "isShowTip", "limit", "tips", "code"],
    },
    file: {
        el: "uploadFile",
        name: "文件",
