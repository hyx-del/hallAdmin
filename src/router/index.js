 ...
 * @LastEditors: zx
 * @LastEditTime: 2021-12-31 10:32:50
 * @Descripttion:
 */
...
export const constantRoutes = [
    ...
    {
        path: "/template3",
        component: () => import("@/views/template3/index.vue"),
    },
    {
        path: "/template4",
        component: () => import("@/views/template4/index.vue"),
    },
    {
        path: "/template5",
        component: () => import("@/views/template5/index.vue"),
    },
    {
        hidden: true,
        path: "/template/add",
